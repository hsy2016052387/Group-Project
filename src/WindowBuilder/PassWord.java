...
public class PassWord extends JPanel {
	...
	public PassWord() {
		...
		JLabel lblNewLabel_6 = new JLabel("Õ¯’æ£∫     Study∆ΩÃ®(https://study.jnu.edu.cn) ");
		lblNewLabel_6.setBounds(88, 32, 425, 33);
		lblNewLabel_6.setFont(new Font("ÀŒÃÂ", Font.PLAIN, 18));
		panel_1.add(lblNewLabel_6);
		
		JLabel lblNewLabel_7 = new JLabel("’À∫≈£∫");
		lblNewLabel_7.setBounds(88, 89, 77, 27);
		lblNewLabel_7.setFont(new Font("ÀŒÃÂ", Font.PLAIN, 18));
		panel_1.add(lblNewLabel_7);
		
		JLabel label_24 = new JLabel("√‹¬Î£∫");
		label_24.setBounds(88, 139, 77, 27);
		label_24.setFont(new Font("ÀŒÃÂ", Font.PLAIN, 18));
		...
		JLabel lblhttpsijnueducn = new JLabel("Õ¯’æ£∫      ˝◊÷Ùﬂ¥Û(https://i.jnu.edu.cn)  ");
		lblhttpsijnueducn.setBounds(88, 220, 425, 33);
		lblhttpsijnueducn.setFont(new Font("ÀŒÃÂ", Font.PLAIN, 18));
		panel_1.add(lblhttpsijnueducn);
		
		JLabel label_25 = new JLabel("’À∫≈£∫");
		label_25.setBounds(88, 266, 77, 27);
		label_25.setFont(new Font("ÀŒÃÂ", Font.PLAIN, 18));
		panel_1.add(label_25);
		
		JLabel label_26 = new JLabel("√‹¬Î£∫");
		label_26.setBounds(88, 314, 77, 27);
		label_26.setFont(new Font("ÀŒÃÂ", Font.PLAIN, 18));
		...
		JLabel label_27 = new JLabel("–£‘∞ø®");
		label_27.setFont(new Font("ÀŒÃÂ", Font.PLAIN, 18));
		label_27.setBounds(88, 396, 425, 33);
		panel_1.add(label_27);
		
		JLabel label_28 = new JLabel("’À∫≈£∫");
		label_28.setFont(new Font("ÀŒÃÂ", Font.PLAIN, 18));
		label_28.setBounds(88, 445, 77, 27);
		panel_1.add(label_28);
		
		JLabel label_29 = new JLabel("√‹¬Î£∫");
		label_29.setFont(new Font("ÀŒÃÂ", Font.PLAIN, 18));
		...
		JButton btnNewButton_2 = new JButton("±£¥Ê");
