...
public class WorkInfo extends JPanel {
	...
	public WorkInfo() {
		...
		JLabel label_1 = new JLabel("农行广东省分行2019春季校园招聘公告");
		...
		JLabel label_3 = new JLabel("时代中国2019春季校园招聘公告");
		...
		JLabel label_5 = new JLabel("广发卡2019春季校园——不一young的精彩");
		...
		JLabel label_7 = new JLabel("中肯集团招聘启事");
		label_7.setFont(new Font("Dialog", Font.PLAIN, 18));
		label_7.setBounds(133, 291, 398, 37);
		panel.add(label_7);
		
		JLabel label_8 = new JLabel("2018海交会全球大学生双选招聘会");
