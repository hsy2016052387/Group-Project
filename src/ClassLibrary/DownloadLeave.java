...
public class DownloadLeave {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					DownloadLeave window = new DownloadLeave();
	...
	public void initialize() {
		...
		comboBox.setModel(new DefaultComboBoxModel(new String[] {"\u8BF7\u5047\u6A21\u677F", "\u5B9E\u9A8C\u62A5\u544A\u6A21\u677F", "\u8BFE\u7A0B\u8BBA\u6587\u6A21\u677F","\u8bfe\u5ba4\u7533\u8bf7\u6a21\u677f"}));
		...
		button.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				// TODO
				File source = new File("./documentTemplate/\u8bf7\u5047\u6761.doc");
